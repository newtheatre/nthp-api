...
class TestPersonGraduated:
    def test_from_year_1999_estimated(self):
        assert schema.PersonGraduated.from_year(
            ...
            year_title="1999", year_decade=199, year_id="1998-99", estimated=True
        )
    ...
    def test_from_year_2000_actual(self):
        assert schema.PersonGraduated.from_year(
            ...
            year_title="2000", year_decade=199, year_id="1999-00", estimated=False
        )
    ...
    def test_from_year_2001_estimated(self):
        assert schema.PersonGraduated.from_year(
            ...
            year_title="2001", year_decade=200, year_id="2000-01", estimated=True
        )
